...
num_match_greater_inn2=len(match_greater_200[match_greater_200["total_y"]>=match_greater_200["total_x"]])
print(num_match_greater_inn2/num_match_greater_inn1_200)
...
print(df_ipl.groupby(["year"])["winner"].value_counts())
